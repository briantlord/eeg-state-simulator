...
def main() -> int:
    ...
    out = {
        'schema': 'projection/2',
        'attribution': (
            'Computed from the fsaverage template subject, distributed with MNE-Python and '
            'derived from FreeSurfer. All or portions of this licensed product (such portions '
            'are the "Software") have been obtained under license from The General Hospital '
            'Corporation and are subject to the FreeSurfer Software License Agreement, '
            'https://surfer.nmr.mgh.harvard.edu/fswiki/FreeSurferSoftwareLicense . Cortical '
            'patches use the Desikan-Killiany parcellation (Desikan et al. 2006, NeuroImage '
            '31(3)). Clinical applications are neither recommended nor advised. See '
            'LICENSE-DATA.md.'
        ),
        'note': (
