...
| Respiratory realism R1–R5 | **done** | continuous variable breathing, RR-domain RSA, state/scalp EEG coupling, count-preserving NREM event hazards, schema-v5 truth + UI contrasts (Findings 37–41) |
| Cortical infra-slow ISF-0–7 | **provisional release** | lead-field source families + continuous controller; wake/N2 PLV 0.169/0.205 against 0.178/0.211; drift deferred (D33, Finding 49) |
| Observables χ / LZc / coupling | **done** | pink-noise demo passes under both LZ parses |
| SNR calibration | **done** | `snr_nominal` = 3.2887 dB, re-solved after D33 changed the released slow-source budget; held-out G5 null passes |
