...
| `topo_sigma_far` | — *(pending T1-M1; runs on 2.5)* | normalized_10_20 | `invented` | hand-chosen; the fitted quantity is topo_far_field_fraction, and the two trade off | all |
